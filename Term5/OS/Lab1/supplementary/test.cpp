...
int main() {
  ...
  static_assert(std::is_same<bool, os::lab1::compfuncs::op_group_traits<os::lab1::compfuncs::OR>::value_type>(),
                "wrong typing for OR");

  std::cout << "f(0) and g(0): " << std::endl;
  std::cout << std::boolalpha << "f(0) hard failed is " << std::holds_alternative<os::lab1::compfuncs::hard_fail>(
      os::lab1::compfuncs::trial_f<os::lab1::compfuncs::INT_SUM>(0)) << std::endl;
  ...
  std::cout << "f(50): " << os::lab1::compfuncs::trial_f<os::lab1::compfuncs::INT_SUM>(50) << std::endl;
}
